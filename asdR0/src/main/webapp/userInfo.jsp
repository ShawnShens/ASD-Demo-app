        ...
        <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-body text-center">
                    ...
                    <!--           button         -->
                    <div class="text-center"><a class="btn btn-primary" href="linkCard.html">Link Card</a></div>
                </div>
            </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="row pv-lg">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="text-right"><a class="btn btn-primary" href="main.html">Main Page</a></div>
                        </div>
                    </div>
                </div>
            </div>
